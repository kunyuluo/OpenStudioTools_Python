...
from Projects.Template.Systems import hvac_system
from Projects.Template.Schedule import add_schedules
from OutputData.OutputData import output_variables

# Project Info:
# **************************************************************************************
project_name = "Template"
building_name = "Template"
rhino_model_path = "D:\\Projects\\OpenStudioDev\\RhinoGeometry\\ExpoTower_Geo_2.3dm"
...
# # **************************************************************************************
model_file = create_model(epw_path_str, path_str, "Expo Tower", north_axis=0)
model = model_file[0]
path = model_file[1]
