...
# Project Info:
# **************************************************************************************
project_name = "BoxModel"
building_name = "BoxModel"
rhino_model_path = "D:\\Projects\\OpenStudioDev\\RhinoGeometry\\BoxModel.3dm"
...
# # **************************************************************************************
model_file = create_model(epw_path_str, path_str, "Test Building", north_axis=0)
model = model_file[0]
path = model_file[1]
...
geometries = GeometryTool.geometry_from_json(model, file_path, load, cons_set, schedule_sets, internal_mass_cons)
...
# **************************************************************************************
# ZoneTool.add_window_by_ratio(ext_walls, 0.4, True, 0.2, 0.5, 0.7, 0.3)
